...
def save_checkpoint(file_dir, policy_net, target_net, optimizer, memory, i_episode, episode_durations, episode_loss):
...
def load_checkpoint(file_dir, i_episode, input_size, output_size, device='cuda'):
    ...
    return policy_net, target_net, optimizer, memory, i_episode, episode_durations, episode_loss
